...
**Model:** `google/gemma-3-4b-it` | rewizja: `093f9f388b31de276ce2de164bdc2081324b9767` | bloków dekodera: **34** | elementów `hidden_states`: **35**
...
- Kształt: `(1, 24, 2560)`, dtype: `torch.bfloat16`
...
Zgodne - generator korpusu produkuje te same tokeny co model.
